...
SAVE_DIR = "SSVACeDeC_loss_train_test_diff_label_bigff/"
...
if __name__ == "__main__":
    experiment_semi_init_big_feedforward_multiple_label_percent(datasets=_get_dataset_loaders(), algorithms_function=_get_evaluation_algorithms,
