...
def main():
    ...
    list_of_percentages = [1, 5, 15, 20, 50, 100]
    for percentage in list_of_percentages:
        ...
        df = f"C:/Users/Chris/Desktop/Uni/Masterarbeit/Code/ClustPy_semi_supervised/SSVACeDeC_loss_train_test_diff_label_fix/small_ff_512_256_128_10_{percentage}/Results/result.csv"
