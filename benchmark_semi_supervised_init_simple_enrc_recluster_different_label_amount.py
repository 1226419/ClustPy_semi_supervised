...
from clustpy_experiments.experiment_semisupervised_acedec_init import experiment_semi_init_small_feedforward_multiple_label_percent
...
SAVE_DIR = "MyBenchmark_Semisupervised_init_enrc_recluster_var_labels/"
...
if __name__ == "__main__":
    experiment_semi_init_small_feedforward_multiple_label_percent(datasets=_get_dataset_loaders(), algorithms_function=_get_evaluation_algorithms,
